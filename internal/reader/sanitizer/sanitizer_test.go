...
func TestImgWithFetchPriorityAttribute(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			`<img src="https://example.org/image.png" fetchpriority="high" loading="eager">`,
		},
		{
			`<img src="https://example.org/image.png" fetchpriority="low">`,
			`<img src="https://example.org/image.png" fetchpriority="low" loading="eager">`,
		},
		{
			`<img src="https://example.org/image.png" fetchpriority="auto">`,
			`<img src="https://example.org/image.png" fetchpriority="auto" loading="eager">`,
		},
	}
...
func TestImgWithDecodingAttribute(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			`<img src="https://example.org/image.png" decoding="sync" loading="eager">`,
		},
		{
			`<img src="https://example.org/image.png" decoding="async">`,
			`<img src="https://example.org/image.png" decoding="async" loading="eager">`,
		},
		{
			`<img src="https://example.org/image.png" decoding="auto">`,
			`<img src="https://example.org/image.png" decoding="auto" loading="eager">`,
		},
	}
...
func TestMediumImgWithSrcset(t *testing.T) {
	...
	expected := `<img alt="Image for post" src="https://miro.medium.com/max/5460/1*aJ9JibWDqO81qMfNtqgqrw.jpeg" srcset="https://miro.medium.com/max/552/1*aJ9JibWDqO81qMfNtqgqrw.jpeg 276w, https://miro.medium.com/max/1000/1*aJ9JibWDqO81qMfNtqgqrw.jpeg 500w" sizes="500px" loading="eager">`
	output := sanitizeHTMLWithDefaultOptions("http://example.org/", input)
...
func TestSelfClosingTags(t *testing.T) {
	input := `<p>This <br> is a <strong>text</strong> <br/>with an image: <img src="http://example.org/" alt="Test" loading="eager"/>.</p>`
	output := sanitizeHTMLWithDefaultOptions("http://example.org/", input)
...
func TestIFrameWithChildElements(t *testing.T) {
	...
	expected := `<iframe src="https://www.youtube.com/" referrerpolicy="strict-origin-when-cross-origin" sandbox="allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox" loading="eager"></iframe>`
	output := sanitizeHTMLWithDefaultOptions("http://example.com/", input)
...
func TestIFrameWithReferrerPolicy(t *testing.T) {
	...
	expected := `<iframe src="https://www.youtube-nocookie.com/embed/test123" referrerpolicy="strict-origin-when-cross-origin" sandbox="allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox" loading="eager"></iframe>`
	output := sanitizeHTMLWithDefaultOptions("http://example.com/", input)
...
func TestReplaceYoutubeURL(t *testing.T) {
	...
	expected := `<iframe src="https://www.youtube-nocookie.com/embed/test123?version=3&amp;rel=1&amp;fs=1&amp;autohide=2&amp;showsearch=0&amp;showinfo=1&amp;iv_load_policy=1&amp;wmode=transparent" referrerpolicy="strict-origin-when-cross-origin" sandbox="allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox" loading="eager"></iframe>`
	output := sanitizeHTMLWithDefaultOptions("http://example.org/", input)
...
func TestReplaceSecureYoutubeURLWithParameters(t *testing.T) {
	...
	expected := `<iframe src="https://www.youtube-nocookie.com/embed/test123?rel=0&amp;controls=0" referrerpolicy="strict-origin-when-cross-origin" sandbox="allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox" loading="eager"></iframe>`
	output := sanitizeHTMLWithDefaultOptions("http://example.org/", input)
...
func TestReplaceProtocolRelativeYoutubeURL(t *testing.T) {
	...
	expected := `<iframe src="https://www.youtube-nocookie.com/embed/Bf2W84jrGqs" width="560" height="314" allowfullscreen="allowfullscreen" referrerpolicy="strict-origin-when-cross-origin" sandbox="allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox" loading="eager"></iframe>`
	output := sanitizeHTMLWithDefaultOptions("http://example.org/", input)
...
func TestReplaceYoutubeURLWithCustomURL(t *testing.T) {
	...
	expected := `<iframe src="https://invidious.custom/embed/test123?version=3&amp;rel=1&amp;fs=1&amp;autohide=2&amp;showsearch=0&amp;showinfo=1&amp;iv_load_policy=1&amp;wmode=transparent" referrerpolicy="strict-origin-when-cross-origin" sandbox="allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox" loading="eager"></iframe>`
	output := sanitizeHTMLWithDefaultOptions("http://example.org/", input)
