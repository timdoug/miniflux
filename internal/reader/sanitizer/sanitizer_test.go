...
func TestInvidiousIFrameWithPort(t *testing.T) {
	...
	expected := `<iframe src="https://invidious.example.com:3000/embed/1234" sandbox="allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox" loading="eager"></iframe>`
	output := sanitizeHTMLWithDefaultOptions("http://example.com/", input)
